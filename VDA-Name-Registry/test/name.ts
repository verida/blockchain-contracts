...
const veridians = [
  ...
  },
  {
    ...
    privateKey:
      "0xff8ca2b935c1b9029a4f783c307e2ed543c93fa64d2c029e124d09d3409e79ec",
    publicKey:
      "0x04707d7adcbfc528b5f8cb7efd1dce9f5d9b32ed56a0f663d67c036d394bc8bb27e8b8bf53276e14db6e4a4b69a9f42b9e920198fc281b2668805c6fab8ee02646",
  },
  {
    address: "0xA0Bdf2665026a2C2C750EE18688625d340C0AA0f",
    privateKey:
      "0x0ce6e5dcecd8359bcf04162f54325681a09fe3d94ce253e97e6874bccec93a86",
    publicKey:
      "0x048697c917584c849de43490d73a4ca7391db3474bf1a93587eef0ddc4602de3022dfa00e5525ccb4405438de861b52915204e023984419fd87296f40a9543ad84",
  },
];
...
describe("VDA Verification base", () => {
  ...
  it("Address test", async () => {
    ...
    await contract.register(name, did.address, signature, proof);
  });
});
