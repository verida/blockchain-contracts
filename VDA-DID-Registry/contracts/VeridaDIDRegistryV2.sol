...
contract VeridaDIDRegistryV2 is OwnableUpgradeable, IVeridaDIDRegistry {
   ...
   * @dev See {IVeridaDIDRegistry}
   */
  function getDIDs(uint startIndex, uint count) external view override returns(address[] memory) {
